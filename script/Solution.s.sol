...
contract Register is Script, Utils {
    IRegistry public constant REGISTRY =
        IRegistry(0xf6aE79c0674df852104D214E16AC9c065DAE5896); // registry deployed on Optimism mainnet

    function setUp() public {}

    // PLAYER to run this command to register their solution:
    // forge script script/Solution.s.sol:Register --rpc-url OPTIMISM_RPC_URL --broadcast -vvvv
    // forge script script/Solution.s.sol:Register --rpc-url $RPC --private-key $PRIVATE_KEY --broadcast -vvvv
